    ...
    return (
        ...
        <>
                        ...
                        <ol role="list" className="flex items-center space-x-4">
                            ...
                            <li>
                                <div className="flex items-center">
                                    <ChevronRightIcon className="h-5 w-5 flex-shrink-0 text-gray-400" aria-hidden="true" />
                                    <a href="#" className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
                                        Computer Assembly and Organization
                                    </a>
                                </div>
                            </li>
                        </ol>
            ...
            <div className="md:flex md:items-end md:justify-between ">
                <h2 className="text-3xl font-bold leading-7 text-pink-400 sm:text-3xl  ">
                    Computer Assembly and Organization
                </h2>
                <div className='grid grid-cols-3 justify-end'>
                    <h2 className="text-xl font-bold leading-7 text-gray-600 sm:text-xl sm:tracking-tight">
                        CS
                    </h2>
                    <h2 className="text-xl font-bold leading-7 text-gray-600 sm:text-xl sm:tracking-tight">
                        0447
